...
namespace Chronokeep.IO.HtmlTemplates
{
    ...
    #line 1 "D:\ChronoKeep\ChronoKeepWindows\ChronoKeep\IO\HtmlTemplates\HtmlResultsTemplateTime.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public partial class HtmlResultsTemplateTime : HtmlResultsTemplateTimeBase
    {
#line hidden
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            this.Write("\n<html>\n\t<head>\n\t\t<link rel=\'stylesheet\' href=\'bootstrap.css\'>\n\t\t<link rel=\'style" +
                    "sheet\' href=\'style.css\'>\n\t</head>\n\t<body>\n\t\t<div class=\'text-important table-hea" +
                    "der\'><h2>");
 ...
 foreach (string d in distanceResults.Keys)
		{ 
            ...
            #line default
            #line hidden
            this.Write("\n\t\t\t<div class=\"table-header text-important\">");
            ...
            #line 1 "D:\ChronoKeep\ChronoKeepWindows\ChronoKeep\IO\HtmlTemplates\HtmlResultsTemplateTime.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(DivisionDistanceType[d]));
 ...
 foreach (TimeResult r in distanceResults[d])
            ...
            #line 1 "D:\ChronoKeep\ChronoKeepWindows\ChronoKeep\IO\HtmlTemplates\HtmlResultsTemplateTime.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(RunnerLoopsCompleted.ContainsKey(r.EventSpecificId) ? RunnerLoopsCompleted[r.EventSpecificId].ToString() : ""));
            ...
            #line 1 "D:\ChronoKeep\ChronoKeepWindows\ChronoKeep\IO\HtmlTemplates\HtmlResultsTemplateTime.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(RunnerLoopsCompleted.ContainsKey(r.EventSpecificId) ? string.Format("{0:0.#}", RunnerLoopsCompleted[r.EventSpecificId] * DivisionDistancePerLoop[d]) : ""));
 ...
 for (int i=1; i<=(maxLoops.ContainsKey(d)? maxLoops[d] : 0); i++) 
            ...
            #line 1 "D:\ChronoKeep\ChronoKeepWindows\ChronoKeep\IO\HtmlTemplates\HtmlResultsTemplateTime.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(LoopResults.ContainsKey((r.EventSpecificId, i)) ? LoopResults[(r.EventSpecificId, i)].LapTime.Substring(0, LoopResults[(r.EventSpecificId, i)].LapTime.Length > 3 ? LoopResults[(r.EventSpecificId, i)].LapTime.Length -2 : LoopResults[(r.EventSpecificId, i)].LapTime.Length) : ""));
            ...
            this.Write("\n\t\t<script type=\"text/javascript\" src=\'jquery.js\'></script>\n\t\t<script type=\"text/" +
                    "javascript\" src=\'bootstrap.js\'></script>\n\t</body>\n</html>");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class HtmlResultsTemplateTimeBase
    {
        #region Fields
