...
public partial class ReaderPart : UserControl
{
    ...
    private void ReaderPort_GotFocus(object? sender, Avalonia.Input.GotFocusEventArgs e)
    {
    }
    ...
    private void ClockButton_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
    }

    private void RewindButton_Click(object? sender, Avalonia.Interactivity.RoutedEventArgs e)
    {
    }
