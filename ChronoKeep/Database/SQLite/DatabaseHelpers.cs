    ...
    class DatabaseHelpers
    {
        internal static void HardResetDatabase(SQLiteConnection connection)
        {
            using (var transaction = connection.BeginTransaction())
            {
                ...
                command.CommandText = "DROP TABLE alarms; DROP TABLE timing_systems; DROP TABLE age_groups;" +
        ...
        internal static void ResetDatabase(SQLiteConnection connection)
        {
            ...
            {
                SQLiteCommand command = connection.CreateCommand();
                command.CommandText = "DELETE FROM alarms; DELETE FROM timing_systems; DELETE FROM age_groups;" +
